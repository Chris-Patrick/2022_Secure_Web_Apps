...
<head>
	...
	<link rel="stylesheet" href="content/assets/css/icofont.min.css">
...
<body>
	...
	<div class="body-shape">
		<img src="content/assets/images/shape/body-shape.png" alt="shape">
	</div>
		...
		<div class="container">
			<div class="header-holder d-flex flex-wrap justify-content-between align-items-center">
				<div class="brand-logo d-none d-lg-inline-block">
					<div class="logo">
						<a href=".">
							<img src="content/assets/images/logo/OurLogo.png" alt="logo">
						</a>
					</div>
				</div>
				<div class="header-menu-part">
					<div class="header-top">
						<div class="header-top-area">
							<ul class="left">
								<li>
									<i class="icofont-ui-call"></i> <span>+1 (949) 813-1443</span>
								</li>
								<li>
									<i class="icofont-location-pin"></i> Cal Poly Pomona, USA
								</li>
							</ul>
					...
					<div class="header-bottom">
						<div class="header-wrapper justify-content-lg-end">
							<div class="mobile-logo d-lg-none">
								<a href="index.html"><img src="content/assets/images/logo/logo.png" alt="logo"></a>
							</div>
							<div class="menu-area">
								<ul class="menu">
									<li>
								...
								<a href="?ctlr=admin&amp;action=login" class="login"><i class="icofont-user"></i> <span>LOG IN</span> </a>
								<a href="?ctlr=admin&amp;action=register" class="signup"><i class="icofont-users"></i> <span>SIGN UP</span></a>
	...
	<section class="banner-section" style="background-image: url(content/assets/images/banner/bg.jpg);">
		<div class="container">
			<div class="">
				<div class="banner-content text-center">
					<h4 class="fw-normal theme-color mb-4">TODAY BIG MATCHE</h4>
					<img src="content/assets/images/banner/01.png" alt="banner text thumb" class="mb-4">
					<p>Time : 08:30Pm   -  30 December 2021</p>
					<a href="https://www.youtube.com/embed/g5eQgEuiFC8" class="default-button reverse-effect" data-rel="lightcase"><span>Watch Now <i class="icofont-play-alt-1"></i></span> </a>
				</div>
				<div class="banner-thumb d-flex flex-wrap justify-content-center justify-content-between align-items-center align-items-lg-end">
					<div class="banner-thumb-img ml-xl-50-none">
						<a href="team-single.html"><img src="content/assets/images/banner/02.png" alt="banner-thumb"></a>
					</div>
					<div class="banner-thumb-vs">
						<img src="content/assets/images/banner/vs.png" alt="banner-thumb">
					</div>
					<div class="banner-thumb-img mr-xl-50-none">
						<a href="team-single.html"><img src="content/assets/images/banner/03.png" alt="banner-thumb"></a>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="game-item item-layer">
							<div class="game-item-inner bg-1">
								<div class="game-thumb">
									<img src="content/assets/images/game/01.png" alt="game-img">
								</div>
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="game-item item-layer">
							<div class="game-item-inner bg-2">
								<div class="game-thumb">
									<img src="content/assets/images/game/02.png" alt="game-img">
								</div>
								<div class="game-overlay">
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="game-item item-layer">
							<div class="game-item-inner bg-3">
								<div class="game-thumb">
									<img src="content/assets/images/game/03.png" alt="game-img">
								</div>
								<div class="game-overlay">
					...
					<div class="col-lg-3 col-md-4 col-sm-6">
						<div class="game-item item-layer">
							<div class="game-item-inner bg-4">
								<div class="game-thumb">
									<img src="content/assets/images/game/04.png" alt="game-img">
								</div>
								<div class="game-overlay">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="about-image">
							<img src="content/assets/images/about/01.png" alt="about-image">
						</div>
					</div>
								...
								<ul class="about-list">
									<li class="about-item d-flex flex-wrap">
										<div class="about-item-thumb">
											<img src="content/assets/images/about/icon-1.png" alt="Icon">
										</div>
									...
									<li class="about-item d-flex flex-wrap">
										<div class="about-item-thumb">
											<img src="content/assets/images/about/icon-2.png" alt="Icon">
										</div>
										<div class="about-item-content">
									...
									<li class="about-item d-flex flex-wrap">
										<div class="about-item-thumb">
											<img src="content/assets/images/about/icon-3.png" alt="Icon">
										</div>
										<div class="about-item-content">
	...
	<section class="match-section padding-top padding-bottom" style="background-image:url(content/assets/images/match/bg.jpg)">
		<div class="container">
			<div class="section-header">
										...
										<div class="col-xl-4 col-md-6 order-md-2">
											<div class="match-game-team">
												<ul
													...
													<li class="match-team-thumb"><a href="team-single.html"><img src="content/assets/images/match/team-1.png" alt="team-img"></a>
													</li>
													<li class="text-center"><img class="w-75 w-md-100" src="content/assets/images/match/vs.png" alt="vs"></li>
													<li class="match-team-thumb"><a href="team-single.html"><img src="content/assets/images/match/team-2.png" alt="team-img"></a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="col-xl-4 col-md-6 order-md-3">
											<div class="match-game-social">
												<ul
													...
													<li><a href="#"><img src="content/assets/images/match/social-1.png"
																alt="vimeo"></a></li>
													<li><a href="#"><img src="content/assets/images/match/social-2.png"
																alt="youtube"></a></li>
													<li><a href="#"><img src="content/assets/images/match/social-3.png"
																alt="twitch"></a></li>
													...
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-1.png"
																	alt="team-img"></a>
														</div>

													</div>
													<div class="col-2 d-md-none">
														<img src="content/assets/images/match/vs.png" alt="vs">
													</div>
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-2.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
														<div class="match-game-info text-center">
															...
															<ul
																...
																<li><a href="#"><img
																			src="content/assets/images/match/social-1.png"
																			alt="vimeo"></a></li>
																<li><a href="#"><img
																			src="content/assets/images/match/social-2.png"
																			alt="youtube"></a></li>
																<li><a href="#"><img
																			src="content/assets/images/match/social-3.png"
																			alt="twitch"></a></li>
															</ul>
														</div>
													</div>
											...
											<div class="match-content gradient-bg-blue">
												<div class="row align-items-center justify-content-center">
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-3.png"
																	alt="team-img"></a>
														</div>
													...
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-4.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
											...
											<div class="match-content gradient-bg-pink">
												<div class="row align-items-center justify-content-center">
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-5.png"
																	alt="team-img"></a>
														</div>
													...
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-6.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
											...
											<div class="match-content gradient-bg-pink">
												<div class="row align-items-center justify-content-center">
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-7.png"
																	alt="team-img"></a>
														</div>
													...
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-8.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
											...
											<div class="match-content gradient-bg-yellow">
												<div class="row align-items-center justify-content-center">
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-9.png"
																	alt="team-img"></a>
														</div>
													...
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-10.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
											...
											<div class="match-content gradient-bg-blue">
												<div class="row align-items-center justify-content-center">
													<div class="col-md-2 col-5 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html" class="text-center"><img
																	src="content/assets/images/match/teamsm/teamsm-11.png"
																	alt="team-img"></a>
														</div>
													...
													<div class="col-md-2 col-5 order-md-3 p-0">
														<div class="match-team-thumb text-center">
															<a href="team-single.html"><img
																	src="content/assets/images/match/teamsm/teamsm-12.png"
																	alt="team-img"></a>
														</div>
													</div>
													<div class="col-md-8 order-md-2 mt-4 mt-md-0">
				...
				<div class="player-slider">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="player-item-2 text-center" style="background-image: url(content/assets/images/team/1.jpg);">
								<div class="player-inner-2">
									<div class="player-thumb-2">
										<a href="team-single.html"><img src="content/assets/images/team/1.png" alt="team-img"></a>
									</div>
									<div class="player-content-2">
										...
										<ul class="match-social-list d-flex flex-wrap align-items-center justify-content-center">
											<li><a href="#"><img src="content/assets/images/match/social-1.png" alt="vimeo"></a></li>
											<li><a href="#"><img src="content/assets/images/match/social-2.png" alt="youtube"></a></li>
											<li><a href="#"><img src="content/assets/images/match/social-3.png" alt="twitch"></a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="swiper-slide">
							<div class="player-item-2 text-center" style="background-image: url(content/assets/images/team/2.jpg);">
								<div class="player-inner-2">
									<div class="player-thumb-2">
										<a href="team-single.html"><img src="content/assets/images/team/2.png" alt="team-img"></a>
									</div>
									<div class="player-content-2">
						...
						<div class="swiper-slide">
							<div class="player-item-2 text-center" style="background-image: url(content/assets/images/team/3.jpg);">
								<div class="player-inner-2">
									<div class="player-thumb-2">
										<a href="team-single.html"><img src="content/assets/images/team/3.png" alt="team-img"></a>
									</div>
									<div class="player-content-2">
						...
						<div class="swiper-slide">
							<div class="player-item-2 text-center" style="background-image: url(content/assets/images/team/4.jpg);">
								<div class="player-inner-2">
									<div class="player-thumb-2">
										<a href="team-single.html"><img src="content/assets/images/team/4.png" alt="team-img"></a>
									</div>
									<div class="player-content-2">
						...
						<div class="swiper-slide">
							<div class="player-item-2 text-center" style="background-image: url(content/assets/images/team/5.jpg);">
								<div class="player-inner-2">
									<div class="player-thumb-2">
										<a href="team-single.html"><img src="content/assets/images/team/5.png" alt="team-img"></a>
									</div>
									<div class="player-content-2">
	...
	<section class="cta-section padding-bottom">
		<div class="container">
			<div class="cta-wrapper item-layer">
				<div class="cta-item px-4 px-sm-5 pt-4 pt-sm-5 pt-lg-0" style="background-image: url(content/assets/images/cta/bg.jpg);">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="cta-thumb text-end">
								<img src="content/assets/images/cta/01.png" alt="gamer-img">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="video-section padding-top padding-bottom bg-attachment" style="background-image:url(content/assets/images/video/bg.jpg)">
		<div class="container">
			<div class="section-header">
							...
							<div class="row g-4 justify-content-center">
									...
									<div class="video-item">
										<div class="video-inner position-relative">
											<div class="video-thumb position-relative video-overlay">
												<img src="content/assets/images/video/01.jpg" alt="video-thumb" class="w-100">
								...
								<div class="col-lg-6 col-12">
									<div class="video-item">
										<div class="video-inner position-relative">
											<div class="video-thumb position-relative video-overlay">
												<img src="content/assets/images/video/02.jpg" alt="video-thumb" class="w-100">
												<div class="video-icon">
													<a href="https://www.youtube.com/embed/g5eQgEuiFC8" data-rel="lightcase">
														<i class="icofont-play-alt-1"></i>
														<span class="pluse"></span>
							...
							<div class="row g-4 justify-content-center">
								<div class="col-xl-4 col-md-6 col-12">
									<div class="video-item">
										<div class="video-inner position-relative">
											<div class="video-thumb position-relative video-overlay">
												<img src="content/assets/images/video/03.jpg" alt="video-thumb" class="w-100">
												<div class="video-icon">
													<a href="https://www.youtube.com/embed/g5eQgEuiFC8" data-rel="lightcase">
														<i class="icofont-play-alt-1"></i>
														<span class="pluse"></span>
								...
								<div class="col-xl-4 col-md-6 col-12">
									<div class="video-item">
										<div class="video-inner position-relative">
											<div class="video-thumb position-relative video-overlay">
												<img src="content/assets/images/video/04.jpg" alt="video-thumb" class="w-100">
												<div class="video-icon">
													<a href="https://www.youtube.com/embed/g5eQgEuiFC8" data-rel="lightcase">
														<i class="icofont-play-alt-1"></i>
														<span class="pluse"></span>
								...
								<div class="col-xl-4 col-md-6 col-12">
									<div class="video-item">
										<div class="video-inner position-relative">
											<div class="video-thumb position-relative video-overlay">
												<img src="content/assets/images/video/05.jpg" alt="video-thumb" class="w-100">
												<div class="video-icon">
													<a href="https://www.youtube.com/embed/g5eQgEuiFC8" data-rel="lightcase">
														<i class="icofont-play-alt-1"></i>
														<span class="pluse"></span>
				...
				<div class="row g-4 justify-content-center">
						...
						<div class="product-item">
							<div class="product-inner">
								<div class="product-thumb">
									<img src="content/assets/images/product/01.jpg" alt="product-thumb" class="w-100">
								</div>
					...
					<div class="col-xl-3 col-md-4 col-sm-6 col-12">
						<div class="product-item">
							<div class="product-inner">
								<div class="product-thumb">
									<img src="content/assets/images/product/02.jpg" alt="product-thumb" class="w-100">
								</div>
								<div class="product-content text-center p-3">
									<a href="#"><h5 class="product-title">Bigamer T-Shirt Here</h5></a>
									<h5 class="product-price">$380.00</h5>
					...
					<div class="col-xl-3 col-md-4 col-sm-6 col-12">
						<div class="product-item">
							<div class="product-inner">
								<div class="product-thumb">
									<img src="content/assets/images/product/03.jpg" alt="product-thumb" class="w-100">
								</div>
								<div class="product-content text-center p-3">
									<a href="#"><h5 class="product-title">Bigamer T-Shirt Here</h5></a>
									<h5 class="product-price">$380.00</h5>
					...
					<div class="col-xl-3 col-md-4 col-sm-6 col-12">
						<div class="product-item">
							<div class="product-inner">
								<div class="product-thumb">
									<img src="content/assets/images/product/04.jpg" alt="product-thumb" class="w-100">
								</div>
								<div class="product-content text-center p-3">
									<a href="#"><h5 class="product-title">Bigamer T-Shirt Here</h5></a>
									<h5 class="product-price">$380.00</h5>
				...
				<div class="row g-5 justify-content-center row-cols-xl-5 row-cols-md-3 row-cols-2">
						...
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/01.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/02.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/03.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/04.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/05.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/06.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/07.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="content/assets/images/sponsor/08.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
	...
	<div class="blog-section padding-top padding-bottom" style="background-image:url(content/assets/images/blog/bg.jpg)">
		<div class="container">
			<div class="section-header">
				<p>our recent news</p>
				...
				<div class="row g-4 justify-content-center row-cols-lg-2 row-cols-1">
						...
						<div class="blog-item">
							<div class="blog-inner">
								<div class="blog-thumb">
									<img src="content/assets/images/blog/01.jpg" alt="blog-thumb">
								</div>
					...
					<div class="col">
						<div class="blog-item">
							<div class="blog-inner">
								<div class="blog-thumb">
									<img src="content/assets/images/blog/02.jpg" alt="blog-thumb">
								</div>
								<div class="blog-content px-3 py-4">
	...
	<div class="testimonial-section padding-top padding-bottom" style="background-image:url(content/assets/images/testimonial/bg.png)">
		<div class="container">
			<div class="section-header">
				<p>our recent news</p>
									...
									<div class="testimonial-head">
										<div class="testi-top">
											<div class="testimonial-thumb">
												<img src="content/assets/images/testimonial/01.jpg" alt="testimonial">
											</div>
											<div class="name-des">
												<h5>Madley Pondor</h5>
												<p>UI Designer</p>
										...
										<a href="team-single.html"><img src="content/assets/images/testimonial/logo/01.png" alt="testimonial"></a>
									</div>
							...
							<div class="testimonial-item">
								<div class="testimonial-inner">
									<div class="testimonial-head">
										<div class="testi-top">
											<div class="testimonial-thumb">
												<img src="content/assets/images/testimonial/02.jpg" alt="testimonial">
											</div>
											<div class="name-des">
										...
										<a href="team-single.html"><img src="content/assets/images/testimonial/logo/02.png" alt="testimonial"></a>
									</div>
									<div class="testimonial-body">
    ...
    <footer class="footer-section">
                ...
                <div class="row g-3 justify-content-center g-lg-0">
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="footer-top-item lab-item">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="content/assets/images/footer/icons/01.png" alt="Phone-icon">
                                </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="footer-top-item lab-item">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="content/assets/images/footer/icons/02.png" alt="email-icon">
                                </div>
                                <div class="lab-content">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="footer-top-item lab-item">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="content/assets/images/footer/icons/03.png" alt="location-icon">
                                </div>
                                <div class="lab-content">
        ...
        <div class="footer-middle padding-top padding-bottom" style="background-image: url(content/assets/images/footer/bg.jpg);">
            <div class="container">
                        ...
                        <div class="footer-middle-item-wrapper">
                            <div class="footer-middle-item mb-lg-0">
                                <div class="fm-item-title mb-4">
                                    <img src="content/assets/images/logo/logo.png" alt="logo">
                                </div>
                            ...
                            <div class="footer-middle-item mb-lg-0">
                                ...
                                <div class="fm-item-content">
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#"> <img src="content/assets/images/footer/01.jpg" alt="footer-widget-img"></a>
                                            </div>
                                            <div class="lab-content">
                                    ...
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#"><img src="content/assets/images/footer/02.jpg" alt="footer-widget-img"></a>
                                            </div>
                                            <div class="lab-content">
                                    ...
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#"><img src="content/assets/images/footer/03.jpg" alt="footer-widget-img"></a>
                                            </div>
                                            <div class="lab-content">
	...
	<script src="content/assets/js/circularProgressBar.min.js"></script>
