...
<body>
					...
					<div class="header-bottom">
						<div class="header-wrapper justify-content-lg-end">
							<div class="mobile-logo d-lg-none">
								<a href="."><img src="content/assets/images/logo/OurLogo.png" alt="logo"></a>
							</div>
							<div class="menu-area">
								<ul class="menu">
									<li>
	...
	<section class="pageheader-section" style="background-image: url(content/assets/images/pageheader/bg.jpg);">
		<div class="container">
            <div class="section-wrapper text-center text-uppercase">
                <h2 class="pageheader-title">Registration Failure</h2>
...
<div style="text-align: center;">
	...
	<section>
		...
		<br>
			<a href="?ctlr=admin&amp;action=register">
				<div style="display: flex;justify-content: center;">
					<button class="d-block default-button"><span>Return to Registration</span></button>
				</div>
			</a>
		<br>
		<br>
